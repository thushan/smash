...
func init() {
	...
	flags.BoolVarP(&af.HideTop, "hide-top", "", false, "Hides top x duplicates list.")
	...
	flags.BoolVarP(&af.IgnoreEmptyFiles, "ignore-emptyfiles", "", false, "Ignore & don't analysis on empty/zero byte files.")
