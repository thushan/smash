...
func init() {
	...
	flags.BoolVarP(&af.HideTop, "no-top", "", false, "Hides top x duplicates list.")
	...
	flags.BoolVarP(&af.IgnoreEmptyFiles, "ignore-emptyfiles", "", false, "Ignore analysing empty/zero byte files.")
